...
<link rel="preload" href="/content/fonts/ps-main/ps-icons.woff?l1la2n" as="font" crossorigin="anonymous">
        <script nonce="TSMLXXYErJw9xl3PoU73rMfCpjfnIjS4">
            function supportsWebp(){if(!self.createImageBitmap)return!1;const e=new Uint8Array([82,73,70,70,30,0,0,0,87,69,66,80,86,80,56,76,17,0,0,0,47,0,0,0,0,7,208,255,254,247,191,255,129,136,232,127,0,0]),t=new Blob([e],{type:"image/webp"});return createImageBitmap(t).then(function(){return!0},function(){return!1})}supportsWebp()&&document.documentElement.classList.add("webp");
...
(function(window, document, dataLayerName, id) {
    ...
    var qP = [];
    dataLayerName !== "dataLayer" && qP.push("data_layer_name=" + dataLayerName), tags.nonce = "TSMLXXYErJw9xl3PoU73rMfCpjfnIjS4";
...
<div no-keyword-injection class="wrapper">
    ...
    <div class="section-full-width theme-navy-1">
        <h1 class="padding-bottom-small text-center" id="what-do-you-want-to-do">What do you want to do?</h1>
        <div class="container-columns-block">
            ...
            <div>
                <h2 class="heading-3 heading-navy-1 text-center" id="free-up-testing-time-with-scalable-automated-scanning">Free up testing time with scalable, automated scanning</h2>
                <img alt="Scalable automated scanning with Burp Suite Enterprise Edition" src="/burp/images/bsee-attack-burp-illy.png">
                ...
                <div class="container-buttons margin-bottom-medium margin-top-small">
                    <a class="button-orange" href="/burp/enterprise"> Find out more</a>
                    <span class="hidden"></span>
                </div>
                <p class="heading-navy-1 text-center font-size-16">Best for AppSec and vulnerability management teams.</p>
            </div>
            <div>
                <h2 class="heading-3 heading-navy-1 text-center" id="prevent-vulnerable-apps-from-hitting-production">Prevent vulnerable apps from hitting production</h2>
    ...
    <script src="/bundles/public/staticcms.js?v=MHEU4aZloOOy-yd7bhY-YQ828l4" nonce="TSMLXXYErJw9xl3PoU73rMfCpjfnIjS4"></script>
