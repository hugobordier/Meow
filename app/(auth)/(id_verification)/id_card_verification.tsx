  ...
  return (
    <View className="bg-white flex-1 justify-start bg-fuchsia-50 relative px-4">
      <View className="justify-center items-center my-6">
        ...
        <TouchableOpacity className="bg-black px-6 py-3 rounded-lg mb-1 mt-6 w-full">
          <Pressable
            onPress={() =>
      ...
      >
        <BottomSheetView className="items-center justify-content rounded-xl">
          <TouchableOpacity className="flex-row items-center space-x-3">
            ...
            <Text className="text-l my-5">Upload un fichier</Text>
          </TouchableOpacity>
          <TouchableOpacity className="flex-row items-center space-x-3">
            <MaterialCommunityIcons
              ...
              color="black"
            />
            <Text className="text-l my-5">Prendre une photo</Text>
          </TouchableOpacity>
        </BottomSheetView>
      </BottomSheet>
    </View>
